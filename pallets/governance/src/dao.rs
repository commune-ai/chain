...
impl<T: Config> Pallet<T> {
    ...
    pub fn execute_application(user_id: &T::AccountId) -> DispatchResult {
        ...
        PalletChain::<T>::add_balance_to_account(
            ...
            PalletChain::<T>::u64_to_balance(application.application_cost).unwrap(),
        );
