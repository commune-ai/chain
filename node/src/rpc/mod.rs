...
// Runtime
use node_chain_runtime::{opaque::Block, AccountId, Balance, Hash, Nonce};
...
where
    ...
    C::Api:chain_rpc::ChainRuntimeApi<Block>,
    BE: Backend<Block> + 'static,
    ...
    CT: fp_rpc::ConvertTransaction<<Block as BlockT>::Extrinsic> + Send + Sync + 'static,
{
    ...
    use chain_rpc::{ChainApiServer, ChainPallet};
    ...
    io.merge(ChainPallet::new(client).into_rpc())?;
