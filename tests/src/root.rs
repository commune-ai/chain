...
fn test_emission() {
    new_test_ext_with_block(1).execute_with(|| {
        ...
        for i in 0..n {
            ...
            ChainMod::add_balance_to_account(&key_id, 1_000_000_000_000_000);
            ...
            ChainMod::increase_stake(&key_id, &key_id, 1000);
        }
        ...
        for i in 1..n {
            ...
            let key_origin = get_origin(key_id);
            ChainMod::add_balance_to_account(&key_id, 1_000_000_000_000_000);
            let _ = ChainMod::register_subnet(
                key_origin.clone(),
        ...
        let step =
            ChainMod::blocks_until_next_epoch(10, ChainMod::get_current_block_number());
...
fn test_rootnet_registration_requirements() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(ChainMod::get_total_stake_from(&1), 0);
        ...
        assert_eq!(ChainMod::get_total_stake_from(&2), initial_stake + 2);
    });
}
